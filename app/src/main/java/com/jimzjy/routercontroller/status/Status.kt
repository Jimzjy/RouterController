...
class Status : Fragment(), StatusView, ReconnectClickListener {
    ...
    private lateinit var mRecyclerAdapter: DeviceRecyclerAdapter
    private lateinit var mNetworkSpeedView: NetworkSpeedView
    private lateinit var mCoordinatorLayout: StatusCoordinatorLayout
    private lateinit var mSpeedBar: ConstraintLayout
    private lateinit var mSpeedBarLeftText: TextView
    private lateinit var mSpeedBarRightText: TextView
    private lateinit var mStatusPresenter: StatusPresenter
    private lateinit var mDevText: TextView
    ...
    override fun updateSpeedBar() {
        val speedArray = mNetworkSpeedView.speedArray
